    ...
    >
      ...
      <div className="relative p-4">
        <div className="flex items-start justify-between">
          ...
          {icon && (
            <span className={cn("size-7 rounded-md grid place-items-center",
              accent === "ai" ? "bg-ai/15 text-ai" :
  ...
  return (
    <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-6">
      <div>
        ...
        {desc && <p className="text-[13px] text-muted-foreground mt-1 max-w-2xl text-balance">{desc}</p>}
      </div>
